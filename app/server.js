...
app.get("/api/bonSummaryFile", (req, res) => {
    ...
    bons.forEach(b => {
        ...
        worksheet.cell(row, col++).string(safeString(b.pax_units));
    ...
    allInfo.forEach(b => {
        ...
        allWorksheet.cell(row, col++).string(safeString(b.pax_units));
        allWorksheet.cell(row, col++).string(b.kitchen_selects ? "Ja" : "Nej");
        allWorksheet.cell(row, col++).string(b.customer_collects ? "Afhentes" : safeString(b.delivery_adr));
